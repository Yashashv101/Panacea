  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-bg px-4">
      <div className="w-full max-w-sm text-center">
        ...
        <p className="mb-8 text-sm text-ink-secondary">{COPY[variant]}</p>
        <Link to="/login" className="text-xs font-medium uppercase tracking-wide text-accent hover:opacity-80">
          Back to sign in
        </Link>
      </div>
    </div>
