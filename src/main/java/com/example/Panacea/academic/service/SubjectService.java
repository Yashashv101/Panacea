...
public class SubjectService {
    ...
    private void apply(Subject subject, SubjectRequest request) {
        ...
        User primaryStaff = resolvePrimaryStaff(request.primaryStaffId());
        Set<Course> courses = resolveCourses(request.courseIds());
        if (primaryStaff != null) {
            subjectOwnershipGuard.requireSameDepartment(primaryStaff, courses, request.name(), "primary staff for");
        }
        subject.setPrimaryStaff(primaryStaff);
